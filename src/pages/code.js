...
let Code = () => (
  <PageTemplate title='Code of Conduct'>
    ...
    <p>If you are being harassed, notice that someone else is being harassed, or have any other concerns, please contact a member of conference staff immediately. Conference or training staff can be identified as they'll be wearing branded clothing and/or badges.</p>
    ...
    <p>In addition, on the day of the event, a safety team consisting of individuals independent from the local organising team, will be identified that you can contact if you feel unsafe or harrassed.</p>
    <p>We expect participants to follow these rules at conference and workshop venues and conference-related social events.</p>
    <p>Additional options to report Code of Conduct related issues include:</p>
    <ul>
      <li>Email <a href='maito:report@serverlessdays.io'>report@serverlessdays.io</a> with details. This email address is monitored by members of the ServerlessDays Safety Team.</li>
    </ul>
  </PageTemplate>
)
